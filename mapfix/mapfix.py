...
class MapfixApp(App):
    ...
    def __init__(self, language, **kwargs):
        ...
        super(MapfixApp, self).__init__(**kwargs)
    ...
    def on_pause(self):
        ...
        :class:`MapfixApp` to wait until the user
    ...
    def on_resume(self):
        ...
        stored in :meth:`MapfixApp.on_pause`.
        """
        pass
    ...
    def switch_lang(self, language):
        ...
        locales = gettext.translation(
            'mapfix', locale_dir, languages=[self.language]
        )
